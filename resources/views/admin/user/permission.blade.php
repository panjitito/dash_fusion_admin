                ...
                <form id="kt_modal_add_permission_form" class="form" action="#">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <label class="fs-6 fw-semibold form-label mb-2">
                            ...
                            <span class="ms-2" data-bs-toggle="popover" data-bs-trigger="hover" data-bs-html="true" data-bs-content="Type the permission title to be shown on the sidebar.">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" placeholder="Enter a permission title" name="title" />
                        <!--end::Input-->
                    </div>
                    <!--end::Input group-->
                    <!--begin::Actions-->
